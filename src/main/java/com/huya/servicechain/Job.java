...
import com.huya.servicechain.function.TargetEventToProtolBuffer;
import com.huya.servicechain.function.TopologyKeySerialization;
        ...
        try {
            ...
            unionStream.map(new TargetEventToProtolBuffer())
                    ...
                    .addSink(new FlinkKafkaProducer011<>(
                            MyConstant.TARGET_KAFKA_TOPIC, new TopologyKeySerialization(), MyConstant.getTargetKafkaProps()
                    ))
                    .setParallelism(32)
