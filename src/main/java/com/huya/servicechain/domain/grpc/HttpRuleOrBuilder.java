...
public interface HttpRuleOrBuilder extends
   ...
   * <code>.google.api.CustomHttpPattern custom = 8;</code>
   */
  com.huya.servicechain.domain.grpc.CustomHttpPattern getCustom();
  /**
   * <pre>
   * The custom pattern is used for specifying an HTTP method that is not
   * included in the `pattern` field, such as HEAD, or "*" to leave the
   ...
   * <code>.google.api.CustomHttpPattern custom = 8;</code>
   */
  com.huya.servicechain.domain.grpc.CustomHttpPatternOrBuilder getCustomOrBuilder();
   ...
   */
  java.util.List<com.huya.servicechain.domain.grpc.HttpRule> 
   ...
   * <code>repeated .google.api.HttpRule additional_bindings = 11;</code>
   */
  com.huya.servicechain.domain.grpc.HttpRule getAdditionalBindings(int index);
  /**
   * <pre>
   * Additional HTTP bindings for the selector. Nested bindings must
   * not contain an `additional_bindings` field themselves (that is,
   ...
   * <code>repeated .google.api.HttpRule additional_bindings = 11;</code>
   */
  java.util.List<? extends com.huya.servicechain.domain.grpc.HttpRuleOrBuilder> 
   ...
   * <code>repeated .google.api.HttpRule additional_bindings = 11;</code>
   */
  com.huya.servicechain.domain.grpc.HttpRuleOrBuilder getAdditionalBindingsOrBuilder(
      int index);

  public com.huya.servicechain.domain.grpc.HttpRule.PatternCase getPatternCase();
}
